...
import json
import os
os.system('title Webhook Spammer - Config')
done = 1
messages = ''
try:
...
os.system('title Webhook Spammer - Enter webhook URL!')
...
os.system('title Webhook Spammer - Enter number of messages to be sent!')
times = input('\u001b[0m\u001b[32;1m[\u001b[0m?\u001b[32;1m] (Enter a NUMBER) \u001b[0m\u001b[33mhow many times do you want to spam the webhook? \u001b[0m>>>\u001b[33m ') or 69
try:
    times = int(times)
except:
    print('\u001b[0m\u001b[31m[\u001b[0m-\u001b[31m] Failed! \u001b[33mYou did not enter a valid number, going with 69! (funny number)')
    times = 69

os.system('title Webhook Spammer - Ready')
